...
resource "aws_db_instance" "oracle_instance" {
  identifier             = "myoracleinstance"
  allocated_storage      = var.allocated_storage
  storage_type           = "gp2"
  engine                 = "oracle-se2"  # Specify the Oracle edition you are using
  engine_version         = "19.0.0.0.ru-2021-07.rur-2021-07.r1"  # Update with your desired Oracle version
